...
import en.app.copybean.impl.CashBackCopyBeanImpl;
 ...
 */
@Service
public class ICashBackServiceImpl extends GridServiceImpl implements ICashBackService{
    @Override
    protected ICopyBean getCopyBean() {
        CashBackCopyBeanImpl cbcb = new CashBackCopyBeanImpl();
        cbcb.setGridDao(gridDao);
        return cbcb;
    }
